...
function Farmer_Own_Post({ state }) {
  ...
  useEffect(() => {
    ...
    const getDetail = async () => {
      ...
      const nameText = await contract.methods.getFarmerPosts(accounts[0], 0).call();
...
export default Farmer_Own_Post;
